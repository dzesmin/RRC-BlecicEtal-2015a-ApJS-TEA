...
def autoCEA(abun, pres, temp, in_elem, out_spec):
    ...
    if abun == 'abundances.txt':
        ...
        for data in np.arange(len(temp)): 
                ...
                subprocess.call(['/home/jasmina/Work/TEA/TEA-APJSupp-paper/TEA-paper-runs/test-compendium/WASP-43b-freeEnergiesCEA/CEA/FCEA2-cmd', desc.encode()])
...
out  = '/home/jasmina/Work/TEA/TEA-APJSupp-paper/TEA-paper-runs/test-compendium/WASP-43b-freeEnergiesCEA/CEA-outputs'
path = out + '/*.out'
...
filename = '/home/jasmina/Work/TEA/TEA-APJSupp-paper/TEA-paper-runs/test-compendium/WASP-43b-freeEnergiesCEA/TEArun-freeEneregiesCEA/results/TEArun-FreeEnergiesCEA.tea'
species = 'H,CO,CO2,CH4,H2O,HCN,C2H4,N2,NH3,H2S'
...
# free energies TEA
plt.savefig('CEA-TEA-WASP-43b-freeEnergiesCEA.png', dpi=300)
plt.savefig('CEA-TEA-WASP-43b-freeEnergiesCEA.ps', dpi=300)
